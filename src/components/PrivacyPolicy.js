...
const PrivacyPolicy = ({ openPrivacyModal }) => {
    ...
    return (
        <Wrapper openPrivacyModal={openPrivacyModal}>
            ...
            <TextWrapper>
                <Text >"Dream Vortex" JSC. respects your concerns about privacy. We want you to understand the types of information we collect, how we use that information, how we secure it, and whether we share it. When you use our websites, software, and applications, you agree to our collection, use, disclosure, and transfer of information as described in this policy, so we urge you to review it carefully. This policy applies to "Dream Vortex" JSC and its licensees. It does not apply to platforms and distribution platforms that may feature "Dream Vortex" JSC products under their own rules.
                    s</Text>
                <Text>Please contact us if you have any questions.</Text>
                <TextTitle>Information we collect or receive
                </TextTitle>
                <Text>We only collect, use, share, store, or otherwise process your personal information when we have a reasonable motive to do so. For example, we may process your personal information as necessary to provide services that are subject to terms you have accepted, such as our Terms of Use. We may process your personal information when necessary to comply with legal obligations or for purposes of pursuing legitimate interests, if doing so is consistent with your rights and appropriate to the context, such as providing services, addressing game performance, fixing bugs, performing internal analytics, and conducting reasonable monitoring of your use of our services to prevent misuse of our services and fraud. Additionally, we may, in certain cases, ask you for your consent for certain processing of your personal information.</Text>
                <Text>We generally collect or receive information in three ways: (a) you voluntarily provide information to us, such as by creating an account, making purchases, or signing up for email alerts, (b) we collect information automatically, such as through cookies or other software, and (c) other parties, such as social networks, may provide information to us. Each of these methods is described in more detail below.</Text>
                <TextTitle>(a) Information you voluntarily choose to provide
                </TextTitle>
                <Text>You may provide your personal information to us when you choose to use our websites, software, or applications. As our products and features may change, the options you have to provide us with information also may change. The following are some examples of situations in which you may provide information to us:
                </Text>
                ...
                <Text>We may also disclose information about you: (1) if we are required to do so by law, legal process, or a reasonable request from law enforcement authorities or other government officials, (2) when we believe disclosure is necessary or appropriate to prevent physical harm or financial loss or in connection with an investigation of suspected or actual illegal activity, or (3) if necessary to protect the vital interests of another individual (such as to prevent death, bodily harm, or serious damage to property). We reserve the right to transfer information about our users in the event we sell or transfer all or substantially all our business or assets.</Text>
                <TextTitle>Your Choices</TextTitle>
                <Text>We provide you with choices about whether to provide us with personal information and whether it is shared. For example, we may seek your prior consent for certain processing. We are required to seek your consent before we use your personal information for any purpose incompatible with the purposes identified in this policy. You may withdraw your consent at any time by sending an email as specified in the “How to contact us” section below. Any withdrawal of consent is only effective on a going-forward basis and will not impact the processing we undertook while relying on your consent</Text>
